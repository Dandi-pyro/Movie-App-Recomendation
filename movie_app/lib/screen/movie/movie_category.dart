...
class CategoryWidget extends StatefulWidget {
  ...
  const CategoryWidget({ Key? key, this.selectedGenre=28}) : super(key: key);
...
class _CategoryWidgetState extends State<CategoryWidget> {
  ...
  void initState() {
    ...
    Provider.of<MovieViewModel>(context, listen: false).getCurrentPlayMovies(selectedGenre!);
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        ...
                        movieProvider.getCurrentPlayMovies(selectedGenre!);
                      });
                    },
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: (categoryProvider.genres[index].id == selectedGenre)
                          ? Colors.black45
                          : Colors.white,
                      ),
                      child: Text(
        ...
        Container(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return movie==null?const CircularProgressIndicator(): Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget> [
                  GestureDetector(
                    onTap: () {
